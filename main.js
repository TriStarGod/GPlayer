...
document.addEventListener("DOMContentLoaded", function (g) {
	...
	function Activate(e) {
		let files = document.querySelectorAll("*[download_url*='.mp3']:not(.hasMP3Player)");
		DecodeAudio(files);
		files = document.querySelectorAll("*[download_url*='.MP3']:not(.hasMP3Player)");
		DecodeAudio(files);
		files = document.querySelectorAll("*[download_url*='.wav']:not(.hasMP3Player)");
		DecodeAudio(files);
		files = document.querySelectorAll("*[download_url*='.WAV']:not(.hasMP3Player)");
		DecodeAudio(files);
	};
